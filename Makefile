...
#    Updated: 2023/09/10 21:05:53 by ory              ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CFLAGS = -Wall -Wextra -Werror  -g  -pg -I. #-fsanitize=address
LIBFT = libft/libft.a
HDR = cub3d.h
NAME = cub3D
...
# # LFLAGS pour Linux
# # LFLAGS = -Lminilibx_opengl -lmlx -Llibft -lft -lXext -lX11 -lm -lz

# # LFLAGS pour MacOS
# LFLAGS = -Lminilibx_opengl -lmlx -framework OpenGL -framework AppKit -Llibft -lft

# CFLAGS = -Wall -Wextra -Werror -g  -I.# Pas d'optimisation - pas de -O
